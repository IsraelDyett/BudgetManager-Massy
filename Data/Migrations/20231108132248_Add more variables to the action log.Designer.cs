...
namespace BudgetManager.Data.Migrations
{
    ...
    [Migration("20231108132248_Add more variables to the action log")]
    partial class Addmorevariablestotheactionlog
    {
            ...
            modelBuilder.Entity("BudgetManager.Models.ActionLog", b =>
                {
                    ...
                    b.Property<string>("ButtonClicked")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OnClickEvent")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
